...
const button = tv({
  ...
  variants: {
    variant: {
      primary:'bg-violet-500 text-violet-50 hover:bg-violet-600 ring-violet-500 min-w-20 cursor-pointer',
        secondary: 'bg-zinc-900 text-zinc-400 ring-zinc-900 min-w-20',
    },
